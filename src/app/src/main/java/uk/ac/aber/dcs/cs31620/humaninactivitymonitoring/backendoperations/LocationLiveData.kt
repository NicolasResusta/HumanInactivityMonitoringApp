...
/**
 * This class takes keeps track of the user's location by storing the data continously in a LiveData
 * list.
 */
class LocationLiveData (var context: Context): LiveData<LocationDetails>() {
    ...
    /**
     * This function sets out the start of the location tracking once the user grants access to their
     * location.
     *
     * @return the user's initial location
     */
